...
{
template <>
class backend::SimSystemCreator<cuda_mixed::InterPrimitiveConstitutionManager>
{
  public:
    static U<cuda_mixed::InterPrimitiveConstitutionManager> create(SimEngine& engine)
    {
        ...
        return uipc::make_unique<cuda_mixed::InterPrimitiveConstitutionManager>(engine);
    }
};
}  // namespace uipc::backend
...
muda::DoubletVectorView<InterPrimitiveConstitutionManager::StoreScalar, 3>
InterPrimitiveConstitutionManager::GradientHessianInfo::gradients() const noexcept
{
    auto [offset, count] = m_impl->constitution_gradient_offsets_counts[m_index];
    return m_gradients.subview(offset, count);
}

muda::TripletMatrixView<InterPrimitiveConstitutionManager::StoreScalar, 3>
InterPrimitiveConstitutionManager::GradientHessianInfo::hessians() const noexcept
{
