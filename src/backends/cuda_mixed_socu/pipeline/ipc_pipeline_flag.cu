...
{
template <>
class backend::SimSystemCreator<cuda_mixed::IPCPipelineFlag>
{
  public:
    static U<cuda_mixed::IPCPipelineFlag> create(SimEngine& engine)
    {
        ...
        return uipc::make_unique<cuda_mixed::IPCPipelineFlag>(engine);
    }
};
}  // namespace uipc::backend
