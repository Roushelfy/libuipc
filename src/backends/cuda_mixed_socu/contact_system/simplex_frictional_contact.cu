...
namespace
{
struct SimplexFrictionalContactExactCache
{
...
SimplexFrictionalContactExactCache& exact_cache(std::shared_ptr<void>& cache)
{
    if(!cache)
        cache = std::make_shared<SimplexFrictionalContactExactCache>();
    return *std::static_pointer_cast<SimplexFrictionalContactExactCache>(cache);
}
    ...
    GlobalDyTopoEffectManager::StructuredHessianInfo& info)
{
    ...
    SimplexFrictionalContactNativeContext native_context;
...
muda::CDoubletVectorView<SimplexFrictionalContact::StoreScalar, 3> SimplexFrictionalContact::PT_gradients() const
{
    return m_impl.PT_gradients;
}

muda::CTripletMatrixView<SimplexFrictionalContact::StoreScalar, 3> SimplexFrictionalContact::PT_hessians() const
{
...
muda::CDoubletVectorView<SimplexFrictionalContact::StoreScalar, 3> SimplexFrictionalContact::EE_gradients() const
{
    return m_impl.EE_gradients;
}

muda::CTripletMatrixView<SimplexFrictionalContact::StoreScalar, 3> SimplexFrictionalContact::EE_hessians() const
{
...
muda::CDoubletVectorView<SimplexFrictionalContact::StoreScalar, 3> SimplexFrictionalContact::PE_gradients() const
{
    return m_impl.PE_gradients;
}

muda::CTripletMatrixView<SimplexFrictionalContact::StoreScalar, 3> SimplexFrictionalContact::PE_hessians() const
{
...
muda::CDoubletVectorView<SimplexFrictionalContact::StoreScalar, 3> SimplexFrictionalContact::PP_gradients() const
{
    return m_impl.PP_gradients;
}

muda::CTripletMatrixView<SimplexFrictionalContact::StoreScalar, 3> SimplexFrictionalContact::PP_hessians() const
{
...
namespace uipc::backend::cuda_mixed
{
using StoreVec3 = Eigen::Matrix<SimplexFrictionalContact::StoreScalar, 3, 1>;
using StoreMat3 = Eigen::Matrix<SimplexFrictionalContact::StoreScalar, 3, 3>;
//PT
