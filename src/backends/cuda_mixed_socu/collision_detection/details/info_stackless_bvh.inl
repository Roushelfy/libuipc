...
{
using aabb = uipc::backend::cuda_mixed::AABB;
using node_t = uipc::backend::cuda_mixed::InfoStacklessBVH::Node;
...
inline void InfoStacklessBVH::detect(muda::CBuffer2DView<IndexT> cmts, NodePred np, LeafPred lp, QueryBuffer& qbuffer)
{
    if(m_aabbs.size() == 0)
    {
        qbuffer.m_size = 0;
