    ...
    return Json{{"solver", "socu_approx"},
                ...
                {"timing",
                 {{"socu_factor_solve_time_ms", report.socu_factor_solve_time_ms},
                  ...
                  {"native_contact_hessian_enabled",
                   report.native_contact_hessian_enabled},
                  {"native_contact_hessian_diff_enabled",
                   report.native_contact_hessian_diff_enabled},
                  {"native_contact_hessian_diff_mismatch_count",
                   report.native_contact_hessian_diff_mismatch_count},
                  {"native_contact_hessian_diff_diag_abs_sum",
                   report.native_contact_hessian_diff_diag_abs_sum},
                  {"native_contact_hessian_diff_offdiag_abs_sum",
                   report.native_contact_hessian_diff_offdiag_abs_sum},
                  {"native_contact_hessian_diff_rhs_abs_sum",
                   report.native_contact_hessian_diff_rhs_abs_sum},
