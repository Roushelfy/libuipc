...
{
template <>
class backend::SimSystemCreator<cuda_mixed::GlobalDiffSimManager>
{
  public:
    static U<cuda_mixed::GlobalDiffSimManager> create(SimEngine& engine)
    {
        ...
        return uipc::make_unique<cuda_mixed::GlobalDiffSimManager>(engine);
    }
};
}  // namespace uipc::backend
