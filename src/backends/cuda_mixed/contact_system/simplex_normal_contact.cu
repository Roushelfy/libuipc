...
muda::CDoubletVectorView<SimplexNormalContact::StoreScalar, 3> SimplexNormalContact::PT_gradients() const
{
    return m_impl.PT_gradients;
}

muda::CTripletMatrixView<SimplexNormalContact::StoreScalar, 3> SimplexNormalContact::PT_hessians() const
{
...
muda::CDoubletVectorView<SimplexNormalContact::StoreScalar, 3> SimplexNormalContact::EE_gradients() const
{
    return m_impl.EE_gradients;
}

muda::CTripletMatrixView<SimplexNormalContact::StoreScalar, 3> SimplexNormalContact::EE_hessians() const
{
...
muda::CDoubletVectorView<SimplexNormalContact::StoreScalar, 3> SimplexNormalContact::PE_gradients() const
{
    return m_impl.PE_gradients;
}

muda::CTripletMatrixView<SimplexNormalContact::StoreScalar, 3> SimplexNormalContact::PE_hessians() const
{
...
muda::CDoubletVectorView<SimplexNormalContact::StoreScalar, 3> SimplexNormalContact::PP_gradients() const
{
    return m_impl.PP_gradients;
}

muda::CTripletMatrixView<SimplexNormalContact::StoreScalar, 3> SimplexNormalContact::PP_hessians() const
{
...
namespace uipc::backend::cuda_mixed
{
using StoreVec3 = Eigen::Matrix<SimplexNormalContact::StoreScalar, 3, 1>;
using StoreMat3 = Eigen::Matrix<SimplexNormalContact::StoreScalar, 3, 3>;
//PT
