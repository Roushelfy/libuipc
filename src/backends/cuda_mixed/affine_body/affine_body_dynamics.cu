...
{
template <>
class backend::SimSystemCreator<cuda_mixed::AffineBodyDynamics>
{
  public:
    static U<cuda_mixed::AffineBodyDynamics> create(SimEngine& engine)
    {
        ...
        return uipc::make_unique<cuda_mixed::AffineBodyDynamics>(engine);
    }
};
}  // namespace uipc::backend
