...
{
template <>
class backend::SimSystemCreator<cuda_mixed::InterAffineBodyConstitutionManager>
{
  public:
    static U<cuda_mixed::InterAffineBodyConstitutionManager> create(SimEngine& engine)
    {
        ...
        return uipc::make_unique<cuda_mixed::InterAffineBodyConstitutionManager>(engine);
    }
};
}  // namespace uipc::backend
...
muda::DoubletVectorView<InterAffineBodyConstitutionManager::StoreScalar, 12> InterAffineBodyConstitutionManager::GradientHessianInfo::gradients() const noexcept
{
