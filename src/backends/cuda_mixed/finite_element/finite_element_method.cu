...
{
template <>
class backend::SimSystemCreator<cuda_mixed::FiniteElementMethod>
{
  public:
    static U<cuda_mixed::FiniteElementMethod> create(SimEngine& engine)
    {
        ...
        return uipc::make_unique<cuda_mixed::FiniteElementMethod>(engine);
    }
};
}  // namespace uipc::backend


bool operator<(const uipc::backend::cuda_mixed::FiniteElementMethod::DimUID& a,
               const uipc::backend::cuda_mixed::FiniteElementMethod::DimUID& b)
{
