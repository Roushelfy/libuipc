        ...
        ParallelFor()
            ...
            .apply(info.energies().size(),
                    ...
                    dt         = info.dt()] __device__(int I)
                   {
                       ...
                       const Alu L0        = safe_cast<Alu>(L0s(I));
                       const Alu h_bar     = safe_cast<Alu>(h_bars(I));
                       const Alu theta_bar = safe_cast<Alu>(theta_bars(I));
                       const Alu V_bar     = safe_cast<Alu>(V_bars(I));
        ...
        ParallelFor()
            ...
            .apply(stencils.size(),
                    ...
                    gradient_only = info.gradient_only()] __device__(int I) mutable
                   {
                       ...
                       const Alu Vdt2 = V_bar * safe_cast<Alu>(dt * dt);
