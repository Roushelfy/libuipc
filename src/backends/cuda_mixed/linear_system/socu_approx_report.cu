                ...
                {"contact",
                 {{"near_band_contact_count", report.near_band_contact_count},
                  ...
                  {"contact_write_plan_skipped_count",
                   report.contact_write_plan_skipped_count},
                  {"contact_write_plan_near_band_count",
                   report.contact_write_plan_near_band_count},
                  {"contact_write_plan_off_band_count",
                   report.contact_write_plan_off_band_count},
