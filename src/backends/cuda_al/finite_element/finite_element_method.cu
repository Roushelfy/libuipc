...
{
template <>
class backend::SimSystemCreator<cuda_al::FiniteElementMethod>
{
  public:
    static U<cuda_al::FiniteElementMethod> create(SimEngine& engine)
    {
        ...
        return uipc::make_unique<cuda_al::FiniteElementMethod>(engine);
    }
};
}  // namespace uipc::backend


bool operator<(const uipc::backend::cuda_al::FiniteElementMethod::DimUID& a,
               const uipc::backend::cuda_al::FiniteElementMethod::DimUID& b)
{
