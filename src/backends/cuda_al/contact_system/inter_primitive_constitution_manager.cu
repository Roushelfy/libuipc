...
{
template <>
class backend::SimSystemCreator<cuda_al::InterPrimitiveConstitutionManager>
{
  public:
    static U<cuda_al::InterPrimitiveConstitutionManager> create(SimEngine& engine)
    {
        ...
        return uipc::make_unique<cuda_al::InterPrimitiveConstitutionManager>(engine);
    }
};
}  // namespace uipc::backend
