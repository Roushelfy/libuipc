...
{
template <>
class backend::SimSystemCreator<cuda_al::GlobalAnimator>
{
  public:
    static U<cuda_al::GlobalAnimator> create(SimEngine& engine)
    {
        ...
        return uipc::make_unique<cuda_al::GlobalAnimator>(engine);
    }
};
}  // namespace uipc::backend
