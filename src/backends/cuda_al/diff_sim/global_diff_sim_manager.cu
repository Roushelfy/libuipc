...
{
template <>
class backend::SimSystemCreator<cuda_al::GlobalDiffSimManager>
{
  public:
    static U<cuda_al::GlobalDiffSimManager> create(SimEngine& engine)
    {
        ...
        return uipc::make_unique<cuda_al::GlobalDiffSimManager>(engine);
    }
};
}  // namespace uipc::backend
