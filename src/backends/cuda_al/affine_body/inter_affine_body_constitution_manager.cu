...
{
template <>
class backend::SimSystemCreator<cuda_al::InterAffineBodyConstitutionManager>
{
  public:
    static U<cuda_al::InterAffineBodyConstitutionManager> create(SimEngine& engine)
    {
        ...
        return uipc::make_unique<cuda_al::InterAffineBodyConstitutionManager>(engine);
    }
};
}  // namespace uipc::backend
...
const AffineBodyDynamics::GeoInfo& cuda_al::InterAffineBodyConstitutionManager::FilteredInfo::geo_info(
...
IndexT cuda_al::InterAffineBodyConstitutionManager::FilteredInfo::body_id(IndexT geo_id) const noexcept
{
...
geometry::SimplicialComplex* cuda_al::InterAffineBodyConstitutionManager::FilteredInfo::body_geo(
