...
{
template <>
class backend::SimSystemCreator<cuda_al::AffineBodyDynamics>
{
  public:
    static U<cuda_al::AffineBodyDynamics> create(SimEngine& engine)
    {
        ...
        return uipc::make_unique<cuda_al::AffineBodyDynamics>(engine);
    }
};
}  // namespace uipc::backend
