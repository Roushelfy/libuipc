...
function(uipc_show_options)
    ...
    message(STATUS "    * UIPC_BUILD_TENSOR_CORE_LAB: ${UIPC_BUILD_TENSOR_CORE_LAB}")
    message(STATUS "    * UIPC_BUILD_TENSOR_CORE_GEMM: ${UIPC_BUILD_TENSOR_CORE_GEMM}")
    ...
    message(STATUS "    * UIPC_WITH_CUDA_MIXED_SOCU_BACKEND: ${UIPC_WITH_CUDA_MIXED_SOCU_BACKEND}")
...
function(uipc_config_vcpkg_install)
    ...
    if(UIPC_WITH_CUDA_BACKEND OR UIPC_WITH_CUDA_MIXED_BACKEND OR UIPC_WITH_CUDA_MIXED_SOCU_BACKEND)
        set(UIPC_WITH_ANY_CUDA_BACKEND ON)
    endif()

    set(UIPC_WITH_ANY_BENCHMARK_TARGET OFF)
    if(UIPC_BUILD_BENCHMARKS OR UIPC_BUILD_TENSOR_CORE_LAB OR UIPC_BUILD_TENSOR_CORE_GEMM)
