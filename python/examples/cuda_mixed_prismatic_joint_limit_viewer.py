"""
cuda_mixed entry point for the prismatic joint limit GUI demo.
...
Run:
    ...
    PYTHONPATH=build/build_impl_path6/python/src uv run --project python --python 3.13 python \
        python/examples/cuda_mixed_prismatic_joint_limit_viewer.py
"""

from prismatic_joint_limit_gui_demo import main
